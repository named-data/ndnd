...
func (context *T1ParsingContext) Parse(reader enc.FastReader, ignoreCritical bool) (value T1, err error) {
...
func (context *T2ParsingContext) Parse(reader enc.FastReader, ignoreCritical bool) (value T2, err error) {
